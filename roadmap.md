...
1. Hostinger folder-upload deployment
   - (Done) Configure a Hostinger Node-compatible Nitro build
   - (Done) Preserve authenticated server workflows and keep private credentials server-side
